  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'soft': '0 2px 4px hsl(var(--foreground) / 0.02), 0 8px 16px hsl(var(--foreground) / 0.04)',
        'premium': '0 4px 6px -1px hsl(var(--primary) / 0.1), 0 10px 30px -5px hsl(var(--primary) / 0.15)',
        'float': '0 10px 40px -10px hsl(var(--primary) / 0.3)',
